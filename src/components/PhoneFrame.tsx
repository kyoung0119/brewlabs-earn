...
const PlaceholderFrame = (props: JSX.IntrinsicAttributes & SVGProps<SVGSVGElement>) => {
  return (
...
const PhoneFrame = ({ className, children, priority = false, ...props }: PhoneFrameProps) => {
  return (
    <div className={clsx("relative aspect-[366/729]", className)} {...props}>
      ...
      <PlaceholderFrame className="pointer-events-none absolute inset-0 h-full w-full fill-gray-300" />
      <Image
        src={frame}
        alt="Brewlabs interface"
