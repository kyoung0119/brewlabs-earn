...
!(function (t, e) {
  ...
  function s() {
    return "1.15 (internal id 8562c7b8 @ 2019-12-18 11:58:08.555993)";
  }
  var r = (function () {
    function t(t) {
      if (
    ...
    return (
      ...
      (t.prototype._render = function () {
        ...
        else if (!Boolean(this._options.symbol)) throw new Error("Symbol is not defined");
        var e =
          (this._options.library_path || "") +
          "static/" +
          encodeURIComponent(this._options.locale) +
          "-tv-chart.8562c7b8f7bdb50c1f5d.html#symbol=" +
